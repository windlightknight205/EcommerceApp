		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
					<a href="Home" class="btn btn-success"><i class="glyphicon glyphicon-home
					"></i></a>
				...
				<tbody>
					<c:forEach items="${listA}" var="o">
						<tr>
							...
							<td>${o.user}</td>
							<td>${o.pass}</td>
							<td> <input type="checkbox" ${o.isshell==1 ? 'checked=checked' : ''}></td>
							<td><input type="checkbox" ${o.isadmin==1 ? 'checked=checked' : ''}></td>
							<td>${o.name}</td>
							<td>${o.age}</td>
							<td>${o.address}</td>
							<td>	
						...
						<div class="form-group">
							<label>Category</label> <select name="category"
								...
								<c:forEach items="${listC}" var="o">
									<option value="${o.cid}">${o.getName()}</option>
								</c:forEach>
							</select>
						</div>
