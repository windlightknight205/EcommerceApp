                                        ...
                                        <table class="table">
                                            ...
                                            <c:set var="total" value="${total + o.product.price * o.quantity }"></c:set>
                                                <tr>
                                                    <th scope="row">
                                                        <div class="p-2">
                                                            <a href="detail?pid=${o.product.id}"><img src="${o.product.image}" style="width:256px;height:256px;" ></a>
                                                            <div class="ml-3 d-inline-block align-middle">
                                                                <h5 class="mb-0"> <a href="detail?pid=${o.product.id}" class="text-dark d-inline-block"></a></h5><span class="text-muted font-weight-normal font-italic">${o.product.name}</span>
                                                            </div>
                                                        </div>
                                                    </th>
                                                    <td class="align-middle"><strong>${o.product.price}</strong></td>
                                                    <td class="align-middle">
                                                        <a href="cart?&action=minus&id=${o.product.id}"><button class="btnSub">-</button></a> 
